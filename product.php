      ...
      <main class="main">
        <div class="product__wrapper">
          ...
          $result = $conn->query($sql); if ($result->num_rows > 0) { $row =
                    $result->fetch_assoc(); $name = $row["name"]; $price = $row["price"];
                     // Шаблон HTML страницы товара
                    echo '
                    <img src="'.$row["image"].'" alt="" class="product__image" width="650" />
                    <div class="product__info">
                      <div class="product__rating">
                        <a href="#" class="product__rating-link"
                          ><svg
                            width="38"
                            height="38"
                            viewBox="0 0 38 38"
                      ...
                      <p class="product__price">'.$row["price"].' руб</p>
                      ...
                      <h4 class="product__sizes-title">Размер, мм</h4>
                      <ul class="product__sizes">
                        <li class="product__sizes-item">
                          <a href="#" class="product__sizes-link">16</a>
                        </li>
                        <li class="product__sizes-item">
                          <a href="#" class="product__sizes-link">16,5</a>
                        </li>
                        <li class="product__sizes-item">
                          <a href="#" class="product__sizes-link">17</a>
                        </li>
                        <li class="product__sizes-item">
                          <a href="#" class="product__sizes-link">17,5</a>
                        </li>
                        <li class="product__sizes-item">
                          <a href="#" class="product__sizes-link">18</a>
                        </li>
                        <li class="product__sizes-item">
                          <a href="#" class="product__sizes-link">18,5</a>
                        </li>
                        <li class="product__sizes-item">
                          <a href="#" class="product__sizes-link">19</a>
                        </li>
                        <li class="product__sizes-item">
                          <a href="#" class="product__sizes-link">19,5</a>
                        </li>
                        <li class="product__sizes-item">
                          <a href="#" class="product__sizes-link">20</a>
                        </li>
                      </ul>
                      <div class="product__btnbox">
                        ...
                        <a href="#" id="addToFavorites" class="product__fav"
                          ><svg
                            ...
                            xmlns:xlink="http://www.w3.org/1999/xlink"
                          >
                            <rect width="50" height="50" fill="url(#pattern0_124_156)" />
                            <defs>
                              <pattern
                                id="pattern0_124_156"
                                patternContentUnits="objectBoundingBox"
                              ...
                              <image
                                ...
                                width="100"
                                height="100"
                                xlink:href="data:image/png;base64,"
                              />
                            </defs>
                          </svg>
                        </a>
                    ...
                    '; } else { echo "Product not found"; } $conn->close(); ?>

          <!-- <img src="img/product.png" alt="" class="product__image" />
          <div class="product__info">
            <div class="product__rating">
              <a href="#" class="product__rating-link"
                ><svg
            ...
            <h2 class="product__title">Кольцо из золота с бриллиантами</h2>
            <p class="product__price">13 990 руб</p>
            <ul class="product__specs">
              <li class="product__specs-item">
                Материал<span class="product__spec"

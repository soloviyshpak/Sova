...
<html lang="ru">
  ...
  <body>
    <div class="wrapper">
      ...
      <main class="main">
        <section class="tradein-banner">
          <div class="container">
            <div class="tradein-banner__inner">
              <p class="tradein-banner__subtitle">Пошли старое… в трейд-ин</p>
              <h1 class="tradein-banner__title">
                Так выгодно, что захочешь поменять всё!
              </h1>
              <a href="#" class="tradein-banner__btn">Узнать скидку</a>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="exchange__inner">
              <div class="exchange__left">
                <h3 class="exchange__left-title">
                  <span class="exchange__left-accent"
                    >Обменяйте старые украшения</span
                  >
                  по самой выгодной цене
                </h3>
              </div>
              <div class="exchange__right">
                <p class="exchange__right-text">
                  Приносите свои ювелирные изделия в любой флагманский магазин
                  SOVÁ и получите скидку до 100% на покупку новых.
                </p>
              </div>
            </div>
          </div>
        </section>
        <section class="howtochange">
          <div class="container">
            <h2 class="howtochange__title">Как обменять украшения?</h2>
            <ul class="howtochange__list">
              <li class="howtochange__item">
                <img
                  src="img/icons/trade-in/new-decor.svg"
                  alt=""
                  class="howtochange__item-img"
                />
                <h4 class="howtochange__item-title">
                  Заберите новое украшение
                </h4>
                <p class="howtochange__item-subtitle">
                  Сообщите продавцу, что хотите оплатить заказ по программе
                  трейд-ин
                </p>
              </li>
              <li class="howtochange__item">
                <img
                  src="img/icons/trade-in/come-to-store.svg"
                  alt=""
                  class="howtochange__item-img"
                />
                <h4 class="howtochange__item-title">
                  Приходите в магазин SOVÁ
                </h4>
                <p class="howtochange__item-subtitle">
                  Принесите украшения, которые вы готовы обменять
                </p>
              </li>
              <li class="howtochange__item">
                <img
                  src="img/icons/trade-in/make-order.svg"
                  alt=""
                  class="howtochange__item-img"
                />
                <h4 class="howtochange__item-title">Оформите заказ</h4>
                <p class="howtochange__item-subtitle">
                  Выберите способ доставки «Магазин SOVÁ» и оплату при получении
                </p>
              </li>
            </ul>
          </div>
        ...
        <section class="instructions">
          <div class="container">
            <div class="instructions__inner">
              <div class="instructions__titlebox">
                <h4 class="instructions__title">1. Добавьте изделие</h4>
              </div>
              <div class="instructions__body">
                <div class="instructions__body-first">
                  <ul class="instructions__body-first_list">
                    <li class="instructions__body-first_item">
                      Перейдите в каталог и выберите украшение
                    </li>
                    <li class="instructions__body-first_item">
                      В карточке товара нажмите «Добавить товар для расчета»
                    </li>
                    <li class="instructions__body-first_item">
                      Перейдите в калькулятор, нажав «Рассчитать скидку»
                    </li>
                  </ul>
                  <img
                    src="img/trade-in/laptop-decor.png"
                    alt=""
                    class="instructions-first-decor"
                  />
                </div>
                <a href="#" class="instructions__body-first_btn"
                  >Перейти в каталог</a
                >
              </div>
            </div>
            <div class="instructions__inner">
              <div class="instructions__titlebox">
                <h4 class="instructions__title">3. Оформите заказ</h4>
              </div>
              <div class="instructions__body">
                <ul class="instructions__second-list">
                  <li class="instructions__second-item">
                    Добавьте украшение в корзину
                  </li>
                  <li class="instructions__second-item">
                    Выберите способ доставки «Магазин SOVÁ», способ оплаты
                    «Оплата при получении»
                  </li>
                  <li class="instructions__second-item">
                    Дождитесь СМС о готовности выбранного украшения к выдаче
                  </li>
                  <li class="instructions__second-item">
                    Приходите в магазин. Возьмите с собой украшения для обмена
                  </li>
                  <li class="instructions__second-item">
                    Назовите продавцу номер заказа и уточните, что хотите
                    воспользоваться программой трейд-ин
                  </li>
                  <li class="instructions__second-item">
                    Продавец проверит вес украшения и рассчитает финальную
                    скидку
                  </li>
                </ul>
              </div>
        ...
        <section class="rules">
          <div class="container">
            <h2 class="rules__title">Основные правила обмена</h2>
            <ul class="rules__list">
              <li class="rules__item">
                <img
                  src="img/icons/trade-in/exchange.svg"
                  alt=""
                  class="rules__item-img"
                />
                <p class="rules__item-text">
                  Обмен осуществляется при самовывозе из магазинов, в которых
                  действует трейд-ин
                </p>
              </li>
              <li class="rules__item">
                <img
                  src="img/icons/trade-in/grade.svg"
                  alt=""
                  class="rules__item-img"
                />
                <p class="rules__item-text">
                  При оценке изделий учитывается только чистый вес металла, без
                  вставок
                </p>
              </li>
              <li class="rules__item">
                <img
                  src="img/icons/trade-in/adult.svg"
                  alt=""
                  class="rules__item-img"
                />
                <p class="rules__item-text">
                  Программа действует только для лиц старше 18 лет при

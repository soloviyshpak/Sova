...
<html lang="ru">
  <head>
    ...
    <title>Сервис и ремонт – Sova</title>
    ...
    <div class="wrapper">
      ...
      <main class="main">
        <section class="service__banner">
          <div class="container">
            <div class="service__banner-wrapper">
              <div class="service__banner-top">
                <h1 class="service__banner-top_title">Ювелир</h1>
                <h2 class="service__banner-top_subtitle">
                  от ведущего производителя в России
                </h2>
                .
                <p class="service__banner-top_text">
                  услуги профессионального ювелира в SOKOLOV
                </p>
              </div>
              <div class="service__banner-bottom">
                <p class="service__banner-bottom_content">
                  Любимое украшение утратило свой первоначальный блеск,
                  сломалось или повредилось? В ювелирной мастерской SOKOLOV
                  вы всегда сможете воспользоваться профессиональными услугами
                  по ремонту и восстановлению драгоценных изделий
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            ...
            <ul class="advantage__cards">
              <li class="advantage__card">
                <img
                  src="img/icons/advantages/service.svg"
                  alt=""
                  class="advantage__card-img advantage__card-img--service"
                />
                <h4 class="advantage__card-title">Широкий выбор услуг</h4>
              </li>
              <li class="advantage__card">
                <img
                  src="img/icons/advantages/advantages.svg"
                  alt=""
                  class="advantage__card-img advantage__card-img--advantages"
                />
                <h4 class="advantage__card-title">Высокий уровень качества</h4>
              </li>
              <li class="advantage__card">
                <img
                  src="img/icons/advantages/professionals.svg"
                  alt=""
                  class="advantage__card-img advantage__card-img--professionals"
                />
                <h4 class="advantage__card-title">
                  Опытные мастера — профессиональные ювелиры
                </h4>
              </li>
              <li class="advantage__card">
                <img
                  src="img/icons/advantages/guarantee.svg"
                  alt=""
                  class="advantage__card-img advantage__card-img--quarantee"
                />
                <h4 class="advantage__card-title">
                  Гарантия 6 месяцев (кроме родирования и золочения)
                </h4>
              </li>
            </ul>
          </div>
        ...
        <section class="services-page">
          <div class="container">
            ...
            <p class="services-page__text">
              Мы хотим, чтобы украшения всегда радовали вас и оставались
              такими же сияющими, как в первый день покупки. Поэтому теперь
              во флагманских магазинах SOVÁ вы можете воспользоваться услугами
              профессионального ювелира
            </p>
            <div class="services-page__info">
              Срок предоставления услуг: до 7 рабочих дней
            </div>
          </div>
        </section>
              ...
              <li class="pricelist__item">
                <a href="clean.php" class="pricelist__item-link">
                  ...
                  <div class="pricelist__item-pricecell">
                    от <span class="pricelist__item-price">200 ₽</span>
                  </div>
                </a>
              </li>
              <li class="pricelist__item">
        ...
        <section class="choice">
          <div class="container">
            <h2 class="choice__title">Преимущества</h2>
            <div class="choice__inner">
              <h3 class="choice__inner-title">Почему<br />выбирают нас?</h3>
              <ul class="choice__advantages">
                <li class="choice__advantages-item">
                  <h4 class="choice__advantages-item_title">
                    Богатый опыт работы ювелиров
                  </h4>
                </li>
                <li class="choice__advantages-item">
                  <h4 class="choice__advantages-item_title">
                    Высокое качество и надёжность исполнения
                  </h4>
                </li>
                <li class="choice__advantages-item">
                  <h4 class="choice__advantages-item_title">
                    Современное и передовое оборудование
                  </h4>
                </li>
                <li class="choice__advantages-item">
                  <h4 class="choice__advantages-item_title">
                ...
                <li class="choice__advantages-item">
                  <h4 class="choice__advantages-item_title">Доступная цена</h4>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section class="wish">
          <div class="container">
            <div class="wish__inner">
              <h4 class="wish__title">
                В мастерской SOVÁ вы получите широкий спектр услуг по ремонту,
                восстановлению и чистке ювелирных изделий из золота и серебра
              </h4>
              <p class="wish__paragraph">
                В мастерской SOVÁ вы получите широкий спектр услуг по ремонту,
                восстановлению и чистке ювелирных изделий из золота и серебра
              </p>
              <p class="wish__paragraph">
                Команда опытных и профессиональных ювелиров — это альянс
                непревзойдённого мастерства и безупречного качества, знаний
                и традиций работы с золотом и серебром, камнями и вставками
                любой сложности. При обращении мастер даст вам профессиональную
                консультацию и ценные рекомендации по уходу за золотыми
                и серебряными украшениями. Индивидуальный подход к каждому
                заказу, где будут учтены все ваши пожелания и выполнены
                в кратчайшие сроки.
              </p>
            </div>
          </div>

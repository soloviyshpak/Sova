    ...
    <div class="wrapper">
      ...
      <div class="container-collection">
        <section class="collection__header">
          <img src="img/collections/1.jpg" alt="" class="collection__header-author">
          <div class="collection__header-preslider">
            <div class="collection__header-slider swiper">
              <h4 class="collection__header-slider_title collection__header-slider_title--rosse">ROSSE</h4>
        ...
        <section class="collection__main">
          ...
          <img src="img/collections/slider/rosse/3.jpg" class="collection__main-right"></img>
        </section>
        <section class="collection__bottom">
          <img src="img/collections/slider/rosse/4.jpg" alt="" class="collection__bottom-left">
          <div class="collection__bottom-right">
            ...
            <div class="collection__bottom-right-good">
              <img src="img/collections/slider/rosse/5.png" alt="" class="collection__bottom-right-good-img">

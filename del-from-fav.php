...
$sql = "DELETE FROM favourites WHERE userId = $userId AND goodsId = $itemId"; // Удаляем запись из таблицы избранных товаров
if ($conn->query($sql) === TRUE) {
    echo "Товар успешно удален из избранного";
} else {
    echo "Ошибка при удалении товара из избранного: " . $conn->error;
}

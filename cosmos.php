...
<html lang="ru">
  ...
  <body>
    <div class="wrapper">
      ...
      <main class="main">
        <section class="cosmos-page">
          <h1 class="cosmos-page__title">Cosmos</h1>
          <img
            src="img/cosmos-page/collection.jpg"
            alt=""
            class="cosmos-page__preview"
          />
          <div class="cosmos-page__preview-descr">
            <div class="cosmos-page__preview-descr-title">
              Мужские часы из золота и стали
            </div>
            <div class="cosmos-page__preview-pricebox">
              <p class="cosmos-page__preview-price">59 990 р</p>
              <a href="#" class="cosmos-page__preview-buy">
                <img src="img/icons/add-to-basket.svg" alt="" />
              </a>
            </div>
          </div>
        </section>
        <div class="product__container">
          ...
          <?php
              ...
              $query = "SELECT * FROM goods WHERE brand = 'Cosmos'";

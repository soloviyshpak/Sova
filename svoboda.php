    ...
    <div class="wrapper">
      ...
      <div class="container-collection">
        <section class="collection__header">
          <img src="img/collections/2.jpg" alt="" class="collection__header-author">
          <div class="collection__header-preslider">
            <div class="collection__header-slider swiper">
              <h4 class="collection__header-slider_title collection__header-slider_title--svoboda">SVOBODA</h4>
              <div class="collection__header-slider_wrapper swiper-wrapper">
                <div class="collection__header-slide swiper-slide">
                  <img src="img/collections/slider/svoboda/1.png" alt="" class="collection__header-slide_img">
                  <p class="collection__header-slide_price">6 000 ₽ </p>
                </div>
                <div class="collection__header-slide swiper-slide">
                  <img src="img/collections/slider/svoboda/2.png" alt="" class="collection__header-slide_img">
                  <p class="collection__header-slide_price">82 000 ₽ </p>
                </div>
                <div class="collection__header-slide swiper-slide">
                  <img src="img/collections/slider/svoboda/5.png" alt="" class="collection__header-slide_img">
                  <p class="collection__header-slide_price">112 000 ₽ </p>
                </div>
              </div>
            </div>
        ...
        <section class="collection__main">
          <div class="collection__main-left">
            <p class="collection__main-left-subtitle">Украшения</p>
            <h4 class="collection__main-left-title">В ЛЁГКОМ СТИЛЕ</h4>
            <div class="collection__main-left-good">
              <img src="img/collections/slider/svoboda/2.png" alt="" class="collection__main-left-good-img">
              <h4 class="collection__main-left-good-title">Браслет из белого золота с бриллиантами и танзанитом</h4>
              <div class="collection__main-left-good-bottom">
                <a href="#" name="156" class="collection__main-left-good-cart addToCart">
                  <img src="img/icons/buttons/plus.svg" width="80" alt="">
                </a>
                <p class="collection__main-left-good-price">82 000 ₽</p>
              </div>
            </div>
          </div>
          <img src="img/collections/slider/svoboda/3.jpg" class="collection__main-right"></img>
        </section>
        <section class="collection__bottom">
          <img src="img/collections/slider/svoboda/4.jpg" alt="" class="collection__bottom-left">
          <div class="collection__bottom-right">
            ...
            <div class="collection__bottom-right-good">
              <img src="img/collections/slider/svoboda/5.png" alt="" class="collection__bottom-right-good-img">
              <h4 class="collection__bottom-right-good-title">Колье из белого золота с бриллиантами</h4>
              <div class="collection__bottom-right-good-bottom">
                <p class="collection__bottom-right-good-price">112 000 ₽ </p>
                <a href="#" name="157" class="collection__bottom-right-good-cart addToCart">
                  <img src="img/icons/buttons/plus.svg" width="80" alt="">
                </a>
              </div>
            </div>
